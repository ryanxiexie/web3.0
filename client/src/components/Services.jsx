...
const Services = () => {
    return (
        <div className='flex flex-col md:flex-row w-full justify-center items-center gradient-bg-services'>
            ...
            <ServiceCard color='bg-[#2953E3]'
                title='Security Guanranteed'
                icon={<BsShieldFillCheck fontSize={21} className='text-white' />}
                subtitle='Security is guanranteed. We always maintain privacy and maitain the quality of our products'
            />
